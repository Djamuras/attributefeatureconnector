<div class="bootstrap">
    ...
    <!-- Front-Office Display Panel -->
    <div class="panel">
        <div class="panel-heading">
            <i class="icon-eye"></i> {l s='Front-Office Display' mod='attributefeatureconnector'}
        </div>

        <div class="alert alert-info">
            {l s='Show mapped feature values directly on product pages so customers can quickly scan the most important attributes generated by this module.' mod='attributefeatureconnector'}
            <p class="help-block">{l s='Only feature values connected through Attribute-Feature Connector mappings are shown here.' mod='attributefeatureconnector'}</p>
        </div>

        <form action="{$update_front_display_url}" method="post" class="form-horizontal">
            <div class="panel-body">
                <div class="form-group">
                    <label class="control-label col-lg-3">{l s='Display on product pages' mod='attributefeatureconnector'}</label>
                    <div class="col-lg-9">
                        <label class="afc-toggle-wrap">
                            <div class="afc-toggle">
                                <input type="checkbox" name="front_display_enabled" value="1" {if $front_display_enabled}checked="checked"{/if}>
                                <span class="afc-toggle-track"></span>
                            </div>
                            <div class="afc-toggle-label">
                                <strong>{l s='Enable product-page mapped features block' mod='attributefeatureconnector'}</strong>
                                <span>{l s='Adds a compact feature summary through the displayProductAdditionalInfo hook.' mod='attributefeatureconnector'}</span>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-lg-3">{l s='Block title' mod='attributefeatureconnector'}</label>
                    <div class="col-lg-9">
                        <input type="text" name="front_display_title" class="form-control" value="{$front_display_title|escape:'html':'UTF-8'}" maxlength="80">
                        <p class="help-block">{l s='Example: Product highlights, Technical details, Key features.' mod='attributefeatureconnector'}</p>
                    </div>
                </div>
            </div>
            <div class="panel-footer">
                <button type="submit" name="update_front_display" class="btn btn-primary pull-right">
                    <i class="icon-save"></i> {l s='Save' mod='attributefeatureconnector'}
                </button>
            </div>
        </form>
