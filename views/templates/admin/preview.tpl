<div class="bootstrap">
    <div class="panel">
        <div class="panel-heading">
            <i class="icon-eye"></i> {l s='Preview Mapping' mod='attributefeatureconnector'}: {$preview_results.feature_name} - {$preview_results.feature_value}
        ...
        <div class="alert alert-info">
            {l s='This preview shows products that will be affected by this mapping. Only the first %d products are displayed.' sprintf=[$preview_results.showing_limit] mod='attributefeatureconnector'}
        </div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>{l s='Matching Attributes' mod='attributefeatureconnector'}</th>
                ...
                <tbody>
                    {foreach from=$preview_results.affected_products item=product}
                        <tr>
                            ...
                            <td>{$product.matching_attributes}</td>
                            <td>
